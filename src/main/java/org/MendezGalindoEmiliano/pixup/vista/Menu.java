...
public class Menu {
    ...
    public static void municipio(){
        System.out.println("Ingresa los datos del municipio");
    }

    public static void estado(){
        System.out.println("Ingresa los datos del Estado");
    }

    public static void colonia(){
    ...
    public static void  alta1(){
        System.out.println("Se ha agregado exitosamente");
    }

    public static void  baja1(){
        System.out.println("Se ha dado de baja exitosamente");
    }

    public static void  cambio1(){
        System.out.println("Se ha cambiado exitosamente");
    }
    ...
    public static void  noDatos(){
        System.out.println("No se encontraron los datos indicados");
    }
    ...
    public static void  numExt(){
        System.out.println("Ingresa el numero exterior");
    }
